...
print('data loaded')
dim_x = 36
data, taskIndex, cluster_number= cm_map_elites.cvt2(k=2000, dim=12,centroid=centroids, cvt_use_cache=True)
...
archive = mt_map_elites.compute(dim_map=2, dim_x=dim_x, f=hexapod, centroids=centroids, tasks=tasks, num_evals=1e6, params=px, log_file=open('cover_max_mean.dat', 'w'), datas=data, taskIndex = taskIndex, cluster_number=cluster_number)
